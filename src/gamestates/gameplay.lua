...
function gameplay:load()
  ...
  signal.connect(self.controllers.attack)
...
function gameplay:update()
  ...
  self.controllers.attack:update()
...
function gameplay:close()
  ...
  signal.disconnect(self.controllers.attack)
